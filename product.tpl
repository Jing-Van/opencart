{% filepath: /Volumes/bath100.com/public_html/catalog/view/theme/cosyone/template/product/product.tpl %}
...
<div id="content" class="<?php echo $class; ?> product" itemscope itemtype="http://data-vocabulary.org/Product">
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom" style="cursor:move" rel="position: 'right', showTitle: false" id='zoom1'><img itemprop="image" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
      <!-- zoom link-->
  ...
  <!-- AddThis Button END -->
   ...
   <div class="right" style="margin-<?php if ($direction == 'rtl') { echo 'right'; } else { echo 'left'; } ?>:<?php echo $thumb_width; ?>px">
      ...
      <?php } ?>
        ...
        <span class="contrast_font" itemprop="availability" content="<?php if ($data_qty > 0) {echo "in_stock"; } else {echo "out_of_stock"; } ?>"><?php echo $text_stock; ?></span> <span class="stock_status <?php if ($data_qty > 0) {echo "in_stock"; } ?>"><?php echo $stock; ?></span> <br />

        <?php if ($vendor) { ?>
        <span class="contrast_font"><?php echo "By: " ; ?></span> <a href="<?php echo $vendor_href; ?>"><?php echo $vendor; ?></a><br />
        <?php } ?>    
        ...
        <?php if (($special_customer) && ($cosyone_product_yousave)) { ?>
        
        <div class="extended_offer">
        
        <div class="price-new"><?php echo $text_special_customer; ?><span class="amount contrast_font" itemprop="price"><?php echo $special_customer; ?></span></div>
        <div class="price-old"><?php echo $text_old_price; ?><span class="amount contrast_font"><?php echo $price; ?></span></div>
        <div class="price-save"><?php echo $text_you_save; ?><span class="amount contrast_font"><?php echo $yousave; ?></span> </div>
        </div>
      ...
      <div class="price">
        ...
        <?php if (!$special && !$special_customer) { ?>
    ...
    <span class="price-old"><?php echo $price; ?></span> <span class="price-new" itemprop="price"><?php echo $special; ?></span>
        <?php } else { ?> 
    <span class="price-old"><?php echo $price; ?></span> <span class="price-new" itemprop="price"><?php echo $special_customer; ?></span>
    <?php } ?>
    <?php } ?>
        <?php } ?>
