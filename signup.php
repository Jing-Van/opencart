...
class ControllerAccountSignUp extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		$data['mvd_signup_show_plan'] = $this->config->get('mvd_signup_show_plan');
                $data['mvd_plan_explain_url'] = $this->url->link('information/information', 'information_id=11');
	...
	public function send() {
		...
		$request .= '&notify_url=' . $this->url->link('account/signup/signup_callback', '', 'SSL');
	...
	public function signup_callback() {
		...
		if ($user_info) {
			...
			curl_setopt($curl, CURLOPT_POST, 'SSL');
			curl_setopt($curl, CURLOPT_POSTFIELDS, $request);
			curl_setopt($curl, CURLOPT_RETURNTRANSFER, 'SSL');
